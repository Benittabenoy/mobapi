...
from clothapi import views as clapiview
...
urlpatterns = [
    ...
    path("api/v1/teq/clothes",clapiview.ClothView.as_view()),
    path("api/v1/teq/clothes/<int:id>",clapiview.ClothDetailView.as_view()),
